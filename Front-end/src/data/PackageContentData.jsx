    ...
    offers: [
      {
        ...
        description:
          "Leaders often bear the weight of significant stress. Our mindfulness programs, set against the tranquil landscapes of Sri Lanka, provide practical techniques to manage stress, allowing you to lead with clarity and resilience.",
      },
      {
    ...
    offers: [
      {
        ...
        description:
          "Equip students with mindfulness tools to reduce stress, improve focus, and excel academically, all within the lush and serene landscapes of Sri Lanka.",
      },
      {
        offer: "Educator Enhancement",
        description:
          "Elevate your teaching skills and classroom management through mindfulness techniques that foster a positive and enriching learning environment.",
      },
      {
        offer: "Cultural Immersion",
        description:
          "Immerse yourself in the rich cultural heritage of Sri Lanka, where mindfulness has thrived for centuries, adding depth to your mindfulness journey.",
      },
    ],
  },
  {
    ...
    offers: [
      {
        ...
        description:
          "Empower your leaders with mindfulness practices that promote clarity, resilience, and authentic leadership in the idyllic settings of Sri Lanka.",
      },
      {
        offer: "Employee Wellness Escapes",
        description:
          "Enhance employee well-being, reduce stress, and create a healthier workplace through our mindfulness programs, tailored for corporate teams.",
      },
      {
        offer: "Team Building Expeditions",
        description:
          "Strengthen team dynamics and collaboration through mindfulness-based team-building activities amidst Sri Lanka’s inspiring landscapes.",
      },
      {
        offer: "Stress Mastery Seminars",
        description:
          "Equip your team with stress-reduction techniques, resulting in a happier and more productive corporate culture.",
      },
    ],
  },
  {
    ...
    offers: [
      ...
      },
      {
        ...
        description:
          "Explore mindfulness as a way of life, discovering how it can improve your relationships, work, and overall happiness.",
      },
      {
        offer: "Stress Reduction",
        description:
          "Learn to manage stress effectively, equipping yourself with the tools to find tranquility in everyday life.",
      },
      {
        offer: "Mindful Meditation (BIBO Meditation)",
        description:
          "Develop a regular meditation practice to cultivate mindfulness, reduce anxiety, and boost self-awareness. Our guided sessions immerse you in the serenity of Sri Lanka’s natural beauty.",
      },
    ],
  },
  {
