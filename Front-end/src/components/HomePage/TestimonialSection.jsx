...
const TestimonialSection = () => {
  ...
  return (
    <section id="testimonial-section" className={`section testimonial-section justify-content-center d-flex ${isMobileView ? 'mobile-view' : ''}`} style={{marginTop: isMobileView? '4rem':'8rem'}}>
